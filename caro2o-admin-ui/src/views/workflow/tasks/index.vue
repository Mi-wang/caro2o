<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['workflow:tasks:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['workflow:tasks:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['workflow:tasks:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="tasksList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="次数限制" align="center" prop="triesLimit" />
...
<script>
import { listTasks, getTasks, delTasks, addTasks, updateTasks } from "@/api/workflow/tasks";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除营销任务编号为"' + ids + '"的数据项？').then(function() {
        return delTasks(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('workflow/tasks/export', {
        ...this.queryParams
